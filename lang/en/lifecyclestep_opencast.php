...
$string['mform_ocworkflow_help'] = 'The Opencast workflow that will be triggered when an event of a series is found during the step process.<br>NOTE: New Opencast workflows based on tags are only retrieved after saving changes to the Opencast workflow tags.';
